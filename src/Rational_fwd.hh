...
#ifndef pplite_Rational_fwd_hh
#define pplite_Rational_fwd_hh 1
...
using Rational = FLINT_Rational;

#else // !PPLITE_USE_FLINT_INTEGER

class GMP_Rational;
using Rational = GMP_Rational;

#endif // !PPLITE_USE_FLINT_INTEGERS

} // namespace pplite

#endif // !defined(pplite_Rational_fwd_hh)
